...
class MovingGoalRocketPlanner:
    ...
    def compute_trajectory(
        ...
        self.t_min = self.goal_target_time - 5
        self.t_max = self.goal_target_time + 5
    ...
    def _get_problem_parameters(self) -> dict:
        ...
        problem_parameters = {
            ...
            "init_t_guess": cvx.Parameter(nonneg=True),
        }
    ...
    def _get_objective(self) -> cvx.Problem:
        ...
        # final time has to be as near as possible to initial guess
        objective += 1e3 * cvx.sum_squares(
            self.variables["p"] - self.problem_parameters["init_t_guess"]
        )
    ...
    def _convexification(self):
        ...
        self.problem_parameters["init_t_guess"].value = self.goal_target_time
