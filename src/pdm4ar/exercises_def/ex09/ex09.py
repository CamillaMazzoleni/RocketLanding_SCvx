...
def get_exercise09():
    ...
    configs = [
        ...
        # "config_satellites2.yaml",
        # "config_satellites3.yaml",
        "config_mov_target.yaml",
        "config_mov_target2.yaml",
        "config_mov_target3.yaml",
        # "config_empty.yaml",
    ]
    ...
    return Exercise[SimContext, None](
        ...
        * 10,  # For debugging, increase value if your report generation is slow!
    )
